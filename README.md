...
Abaixo segue o que foi utilizado para iniciar o projeto e montar a estrutura base para o App na parte do cliente:
...
O aplicativo está nas fases iniciais de desenvolvimento e está funcional apenas em aparelhos Android.
